...
(() => {
        ...
        e.exports = class {
          ...
          zunion(e) {
            ...
            for (const s of e) {
              ...
              if (e)
                for (const [s, r] of e.entries()) t.set(s, (t.get(s) || 0) + r);
            }
      ...
      relative(e, t) {
        ...
        if (l === o)
          if (i > o) {
            ...
            r > o && (e.charCodeAt(1 + l) === n ? (c = l) : 0 === l && (c = 0));
        let h = '';
        for (l = 1 + c + 1; l <= s; ++l)
  ...
  function $e(e) {
    const t = [],
      ...
      r = e;
    return (
      (r.data = et(s, t)), (r.attachments = t.length), { packet: r, buffers: t }
    );
  }
  function et(e, t) {
    if (!e) return e;
        ...
        new Promise(async (e, s) => {
          ...
          const a = new Promise(async (e, s) => {
            ...
            q(
              ...
              t.error,
              async t => {
                JSON.stringify(t).length <= 20971520 && puter._cache.set(r, t),
                  e(t);
              },
              s
            );
    ...
    _t = async function (...e) {
      ...
      return (
        ...
        new Promise(async (e, s) => {
          ...
          let r;
          if (
            (t.path && (r = `readdir:${t.path}`), 'eventual' === t.consistency)
          ) {
            const t = await puter._cache.get(r);
            if (t) return void e(t);
          }
      ...
      return new Promise(async (r, n) => {
        ...
        for (let e = 0; e < p.length; e++)
          if (p[e]) {
            if (p[e].isDirectory)
              ...
              if (
                ('' != i && v.push(p[e]), s.createFileParent && r.includes('/'))
              ) {
                let e;
                n.split('/').forEach(s => {
                  e = e ? `${e}/${s}` : s;
        ...
        h.open('post', `${this.APIOrigin}/batch`, !0),
          ...
          h.upload.addEventListener('progress', function (e) {
            ...
            (r = r > 100 ? 100 : r),
              s.progress && 'function' == typeof s.progress && s.progress(u, r);
          });
  ...
  class qt {
    ...
    stopCacheUpdateTimer() {
      this.cacheUpdateTimer &&
        (clearInterval(this.cacheUpdateTimer), (this.cacheUpdateTimer = null));
    }
  }
  const Ut = class {
      constructor(e) {
  ...
  const jt = class {
    ...
    expireAt = async (e, t) => {
      ...
      return B(['key', 'timestamp'], 'puter-kvstore', void 0, 'expireAt').call(
        this,
        s
      );
    };
    ...
    list = async (...e) => {
      ...
      return (
        ...
        B([], 'puter-kvstore', void 0, 'list', {
          transform: e =>
            t ? (r ? e.filter(e => zt(t, e.key)) : e.filter(e => zt(t, e))) : e,
        }).call(this, s)
      );
    };
  ...
  class es {
    ...
    async requestFolder_(e, t) {
      ...
      if (await this.puter.ui.requestPermission({ permission: `fs:${s}:${t}` }))
        return s;
    }
  }
    ...
    open() {
      if (this.hasUserActivation()) {
        ...
        var e = screen.width / 2 - s / 2,
          t = screen.height / 2 - r / 2;
        window.open(
          `${puter.defaultGUIOrigin}/?embedded_in_popup=true&request_auth=true${
            window.crossOriginIsolated ? '&cross_origin_isolated=true' : ''
          }`,
          n,
          `toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=${s}, height=${r}, top=${t}, left=${e}`
  ...
  class gs {
    ...
    async delete(e) {
      ...
      if (t.result) {
        ...
        return (
          t || (t = {}), delete t[e], await puter.kv.set('user-workers', t), !0
        );
      }
      throw (
      ...
      checkAndUpdateGUIFScache = function () {
        ...
        ys._cache.get(`item:${t}`) ||
          ...
          ys._cache.get(`item:${s}`) ||
            (console.log(`/${e}/Desktop item is not cached, refetching cache`),
            ys.fs.stat(s)),
